package site.clzblog.security.base64;

public class CustomizeBase64 {
    /**
     * 编码表
     */
    ...
    public static void main(String[] args) {
        ...
        byte[] encodeByteArr = CustomizeBase64.encode(codeByteArr);
        String encodeStr = new String(encodeByteArr);
        byte[] decodeByteArr = CustomizeBase64.decode(encodeByteArr);
        String decodeStr = new String(decodeByteArr);
        System.out.println("原始数据:" + codeStr);
        System.out.println("实现编码:" + encodeStr);
        System.out.println("实现解码:" + decodeStr);
    }
}
